...
![Claude agents share the day-to-day maintenance of a codebase, triaging feedback, planning, writing code, reviewing changes, and reporting status. Each owns a clear task and works on its own schedule; people set the goals and review output.](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/6a3be9ee0c7dd123eea0fd08_e35d445f.png)
...
1. 智能体和人类所需的全部信息与访问权限，是否都公开且可被广泛检索？
2. 你能否写下团队的成员名册（包括人类和智能体），并说明每个成员各自负责什么？
3. 团队中的每一位人类和智能体，是否都能用上完成工作所需的恰当工具？
4. 你是否为人类和智能体准备了评分标准（rubric）或测试，用来核验关键的工作成果？
5. 你的团队是否有一个清晰的北极星目标（north star），让每个人都能参照？
